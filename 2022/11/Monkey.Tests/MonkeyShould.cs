...
{
    [Theory]
    [InlineData(0, new[] { 79, 98 }, "old", "*", "19", 23, 2, 3)]
    [InlineData(1, new[] { 54, 65, 75, 74 }, "old", "+", "6", 19, 2, 0)]
    [InlineData(2, new[] { 79, 60, 97 }, "old", "*", "old", 13, 1, 3)]
    [InlineData(3, new[] { 74 }, "old", "+", "3", 17, 0, 1)]
        ...
        int falseMonkey)
    {
        ...
        sut.TrueMonkey.Should().Be(trueMonkey);
        sut.FalseMonkey.Should().Be(falseMonkey);
    }
}