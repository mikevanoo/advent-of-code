...
public class Cave2Should
{
    private readonly ITestOutputHelper _testOutputHelper;

    public Cave2Should(ITestOutputHelper testOutputHelper)
    {
    ...
    public void Create_Grid_From_Sample_Input()
    {
        ...
        sut.Grid.GetUpperBound(0).Should().Be(503 + Cave2.GridPaddingX - 1);
        sut.Grid.GetUpperBound(1).Should().Be(9 + Cave2.GridPaddingY - 1);
    }
    ...
    public void Draw_Rocks_From_Sample_Input()
    {
        ...
        rockCount.Should().Be(20 + 503 + Cave2.GridPaddingX);
        ...
        int expectedSandY)
    {
        ...
        // var actual = sut.DropSand(numberOfSandUnits);
